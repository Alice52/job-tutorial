...
public final class UTCTimeUtil {
    ...
    public static Date zoneToUtc(Date localDate, TimeZone localTimeZone) {
        ...
        calendar.add(
                ...
                0 - localTimeZone.getRawOffset() - localTimeZone.getDSTSavings());
     ...
     */
    public static LocalDateTime zoneToUtc(
            final LocalDateTime localDateTime, final ZoneId fromZone) {
    ...
    public static Date utcToZone(Date UTCDate, TimeZone localTimeZone) {
        ...
        if (UTCDate != null) {
            ...
            calendar.add(
                    Calendar.MILLISECOND,
                    localTimeZone.getRawOffset() + localTimeZone.getDSTSavings());
